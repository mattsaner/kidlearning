...
const STRINGS = {
  en: {
    ...
    explore: 'Explore', findit: 'Find it!', sounds: 'Sounds', draw: 'Drawing', body: 'Body', whereIs: (w) => `Where is ${w}?`, hide: 'Hide & seek', look: (w) => `Look: ${w}!`, notHere: 'Not here!', settings: 'Settings', language: 'Language',
  ...
  fr: {
    ...
    explore: 'Explorer', findit: 'Trouve !', sounds: 'Sons', draw: 'Dessin', body: 'Corps', whereIs: (w) => `Où est ${w} ?`, hide: 'Cache-cache', look: (w) => `Regarde : ${w} !`, notHere: 'Pas là !', settings: 'Réglages', language: 'Langue',
  ...
  de: {
    ...
    explore: 'Entdecken', findit: 'Finde es!', sounds: 'Geräusche', draw: 'Malen', body: 'Körper', whereIs: (w) => `Wo ist ${w}?`, hide: 'Verstecken', look: (w) => `Schau: ${w}!`, notHere: 'Nicht da!', settings: 'Einstellungen', language: 'Sprache',
