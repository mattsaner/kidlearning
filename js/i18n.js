...
const STRINGS = {
  en: {
    ...
    explore: 'Explore', findit: 'Find it!', sounds: 'Sounds', draw: 'Drawing', body: 'Body', whereIs: (w) => `Where is ${w}?`, settings: 'Settings', language: 'Language',
  ...
  fr: {
    ...
    explore: 'Explorer', findit: 'Trouve !', sounds: 'Sons', draw: 'Dessin', body: 'Corps', whereIs: (w) => `Où est ${w} ?`, settings: 'Réglages', language: 'Langue',
  ...
  de: {
    ...
    explore: 'Entdecken', findit: 'Finde es!', sounds: 'Geräusche', draw: 'Malen', body: 'Körper', whereIs: (w) => `Wo ist ${w}?`, settings: 'Einstellungen', language: 'Sprache',
