...
const fish = [
  ...
  { c: 'blue', d: circle(8, 38, 4) },
  { c: 'blue', d: circle(14, 24, 5) },
  { c: 'blue', d: circle(9, 11, 3.5) },
];

const apple = [
  { c: 'green', d: ellipse(64, 24, 13, 6.5) },
  { c: 'brown', d: rect(48, 20, 4.5, 16) },
  { c: 'red', d: circle(50, 58, 28) },
];

const rainbow = ['red', 'orange', 'yellow', 'green', 'blue', 'purple'].map((c, i) => ({
