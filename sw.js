...
const ASSETS = [
  ...
  'js/games/explore.js', 'js/games/findit.js', 'js/games/sounds.js', 'js/games/paint.js', 'js/drawings.js', 'js/games/body.js', 'js/bodyparts.js', 'js/games/hide.js', 'js/playtime.js', 'js/games/music.js', 'js/instruments.js',
